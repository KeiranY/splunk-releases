...
export const enterpriseCurrentReleaseURL = 'https://www.splunk.com/en_us/download/get-started-with-your-free-trial.html'
...
const getDownload = (url: string, product: string): Promise<Download[]> => { return new Promise<Download[]>((resolve, reject) => {
  axios.get(url)
   .then((response) => {
...
const getDownloads = (): Promise<Download[]> => { return new Promise<Download[]>((resolve, reject) => {
